...
def clean_titanic_data(df):
    ...
    #rename columns
    df = df.rename(columns={"embark_town_Queenstown": "embark_Q", "embark_town_Southampton": "embark_S"})

    # Drops columns that are already represented by other columns
    cols_to_drop = ['deck', 'embarked', 'class', 'passenger_id', 'sex', 'embark_town']
...
def impute_town_mode(train, validate, test):
    '''
...
def prep_titanic_data(df):
    '''
    Combines the clean_titanic_data, split_town_data, and impute_mean_age functions.
    '''
