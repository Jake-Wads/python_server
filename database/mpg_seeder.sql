# Source of this data is the mpg data from pydataset.
SELECT "";

TRUNCATE mpg;

INSERT INTO mpg 'Inserting automobile mpg data into mpg table' AS 'INFO';

INSERT INTO mpg (manufacturer,model,displ,year,cyl,trans,drv,cty,hwy,fl,class)
VALUES
